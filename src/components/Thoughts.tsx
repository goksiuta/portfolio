import { thoughts, Thought } from "../data/content";

interface ThoughtsProps {
  onSelect: (thought: Thought) => void;
}

export default function Thoughts({ onSelect }: ThoughtsProps) {
  return (
    <section>
      ...
      <div className="flex flex-col gap-2">
        {thoughts.map((thought, index) => (
          <button
            ...
            className="block text-left w-full group hover:bg-[#F9FBFD] active:bg-[#F2F5F7] rounded-[20px] px-[8px] py-[16px] -mx-[8px] transition-colors"
          >
